...
The `hamster-playwright-component-mui` module provides a component-based abstraction for Material UI components when using Playwright for web automation. It allows you to interact with MUI components in a type-safe, object-oriented manner.
